...
using ViberAdapter.Models.Responses;
using ViberAdapter.Models.Settings;

namespace ViberAdapter.Clients
{
    /// <summary>
    /// Viber API.
    /// </summary>
    public class ViberClient : IViberClient, IDisposable
    {
        ...
        public ViberClient(IOptions<ViberSettings> settings, IHttpClientFactory httpClientFactory)
        {
            var authenticationToken = settings.Value.AuthToken;
